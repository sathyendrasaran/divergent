...
class Pokemon_Scrapping:
    ...
    def open_directories(self):
        ...
        for file_name in range(len(os.listdir(self.dir_path))):
            if (datetime.strptime(os.listdir(self.dir_path)[file_name],'%Y-%m-%d')==datetime.strptime('2016-10-31','%Y-%m-%d')):
...
if __name__=='__main__':
    class_object1=Pokemon_Scrapping("F:\\DataScience\\project3\\pokemon_5378\\data")
